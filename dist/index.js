...
exports.Magnet = exports.tablica = void 0;
var newMagnet_1 = require("../src/newMagnet");
var resizable_1 = require("../src/resizable");
var idek = 0;
var onBoard = 0;
...
var Magnet = /** @class */ (function () {
    ...
    Magnet.prototype.createMagnet = function () {
        ...
        resizable.addEventListener("mousemove", resizable_1.makeResizableDiv);
        var mousePosition;
        var offset = [0, 0];
        var isDown = false;
...
dokument.onclick = newMagnet_1.newMagnet;
// function newMagnet(){
